<?php
/*
 * Elementor Restaurant & Cafe Addon for Elementor Slider Widget
 * Author & Copyright: NicheAddon
*/

namespace Elementor;

if (!isset(get_option( 'rcafe_bw_settings' )['nbeds_slider'])) { // enable & disable

if ( ! defined( 'ABSPATH' ) ) exit; // Exit if accessed directly

class Restaurant_Elementor_Addon_Slider extends Widget_Base{

	/**
	 * Retrieve the widget name.
	*/
	public function get_name(){
		return 'narestaurant_basic_slider';
	}
	...
	*/
	public function get_title(){
		return esc_html__( 'Slider', 'restaurant-cafe-addon-for-elementor' );
	}
	...
	*/
	...
	/**
	 * Register Restaurant & Cafe Addon for Elementor Slider widget controls.
	...
	*/
	protected function _register_controls(){
		...
		$this->start_controls_section(
			'section_slider',
			[
				'label' => __( 'Slider Options', 'restaurant-cafe-addon-for-elementor' ),
			]
		);
		$this->add_control(
			'vertical_dots',
			[
				'label' => esc_html__( 'Vertical Dots?', 'restaurant-cafe-addon-for-elementor' ),
		...
		$repeater->add_control(
			'slider_image',
			[
				'label' => esc_html__( 'Slider Background Image', 'restaurant-cafe-addon-for-elementor' ),
		...
		$repeater->add_control(
			'slider_sub_title',
			[
				'label' => esc_html__( 'Slider Sub Title', 'restaurant-cafe-addon-for-elementor' ),
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
				'placeholder' => esc_html__( 'Type slide sub title here', 'restaurant-cafe-addon-for-elementor' ),
			]
		);
		$repeater->add_control(
			'sub_title_seperator',
			[
				'label' => esc_html__( 'Sub Title Image', 'restaurant-cafe-addon-for-elementor' ),
				'type' => Controls_Manager::MEDIA,
				'default' => [
					'url' => Utils::get_placeholder_image_src(),
				],
		...
		$repeater->add_control(
			'slider_title',
			[
				'label' => esc_html__( 'Slider Title', 'restaurant-cafe-addon-for-elementor' ),
				'type' => Controls_Manager::TEXTAREA,
				'label_block' => true,
				'placeholder' => esc_html__( 'Type slide title here', 'restaurant-cafe-addon-for-elementor' ),
			]
		);
		$repeater->add_control(
			'slider_content',
			[
				'label' => esc_html__( 'Slider Content', 'restaurant-cafe-addon-for-elementor' ),
				'type' => Controls_Manager::TEXTAREA,
				'label_block' => true,
			]
		);
		$repeater->add_control(
			'content_image',
			[
				'label' => esc_html__( 'Content Image', 'restaurant-cafe-addon-for-elementor' ),
				'type' => Controls_Manager::MEDIA,
				'default' => [
					'url' => Utils::get_placeholder_image_src(),
				],
		...
		$repeater->start_controls_tab(
			'button_one',
			[
				'label' => esc_html__( 'Button One', 'restaurant-cafe-addon-for-elementor' ),
			]
		);
		$repeater->add_control(
			'btn_type',
			[
				'label' => __( 'Button Two Type', 'restaurant-cafe-addon-for-elementor' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'button' => esc_html__( 'Button', 'restaurant-cafe-addon-for-elementor' ),
					'link' => esc_html__( 'Simple Link', 'restaurant-cafe-addon-for-elementor' ),
				],
				'default' => 'button',
			]
		);
		...
		$repeater->add_control(
			'btn_txt',
			[
				'label' => esc_html__( 'Button One Text', 'restaurant-cafe-addon-for-elementor' ),
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
				'placeholder' => esc_html__( 'Type your button text here', 'restaurant-cafe-addon-for-elementor' ),
			]
		);
		$repeater->add_control(
			'button_link',
			[
				'label' => esc_html__( 'Button One Link', 'restaurant-cafe-addon-for-elementor' ),
				'type' => Controls_Manager::URL,
				'placeholder' => __( 'https://your-link.com', 'restaurant-cafe-addon-for-elementor' ),
				'show_external' => true,
				'default' => [
					'url' => '',
				],
		...
		$repeater->start_controls_tab(
			'button_two',
			[
				'label' => esc_html__( 'Button Two', 'restaurant-cafe-addon-for-elementor' ),
			]
		);
		$repeater->add_control(
			'btn_type_two',
		...
		$repeater->add_control(
			'btn_two_txt',
			[
				'label' => esc_html__( 'Button Two Text', 'restaurant-cafe-addon-for-elementor' ),
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
				'placeholder' => esc_html__( 'Type your button text here', 'restaurant-cafe-addon-for-elementor' ),
			]
		...
		$repeater->add_control(
			'button_two_link',
			[
				'label' => esc_html__( 'Button Two Link', 'restaurant-cafe-addon-for-elementor' ),
				'type' => Controls_Manager::URL,
				'placeholder' => __( 'https://your-link.com', 'restaurant-cafe-addon-for-elementor' ),
				'show_external' => true,
				'default' => [
		...
		$repeater->add_control(
			'image_style',
			[
				'label' => __( 'Additional Content', 'restaurant-cafe-addon-for-elementor' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'none' => esc_html__( 'None', 'restaurant-cafe-addon-for-elementor' ),
					'image' => esc_html__( 'Image', 'restaurant-cafe-addon-for-elementor' ),
					'content' => esc_html__( 'Content', 'restaurant-cafe-addon-for-elementor' ),
				],
				'default' => 'none',
			]
		);
		$repeater->add_control(
			...
			[
				'label' => esc_html__( 'Slider Content Image', 'restaurant-cafe-addon-for-elementor' ),
				'type' => Controls_Manager::MEDIA,
				'default' => [
					'url' => Utils::get_placeholder_image_src(),
				],
		...
		$repeater->add_control(
			'slider_form',
			[
				'label' => esc_html__( 'Slider Form', 'restaurant-cafe-addon-for-elementor' ),
				'type' => Controls_Manager::TEXTAREA,
		...
		$this->add_control(
			'swipeSliders_groups',
			[
				'label' => esc_html__( 'Slider Items', 'restaurant-cafe-addon-for-elementor' ),
				'type' => Controls_Manager::REPEATER,
				'default' => [
					[
						'slider_title' => esc_html__( 'Item #1', 'restaurant-cafe-addon-for-elementor' ),
					],
		...
		$this->start_controls_section(
			'section_animation',
			[
				'label' => __( 'Slider Animation', 'restaurant-cafe-addon-for-elementor' ),
			]
		);
		$this->add_control(
			'sub_title_animation',
			[
				'label' => esc_html__( 'Title Entrance Animation', 'restaurant-cafe-addon-for-elementor' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Content Entrance Animation', 'restaurant-cafe-addon-for-elementor' ),
				'type' => Controls_Manager::ANIMATION,
			]
		);
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Button Entrance Animation', 'restaurant-cafe-addon-for-elementor' ),
				'type' => Controls_Manager::ANIMATION,
			]
		);
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Image Entrance Animation', 'restaurant-cafe-addon-for-elementor' ),
				'type' => Controls_Manager::ANIMATION,
			]
		);
		$this->end_controls_section();// end: Section
		...
		$this->start_controls_section(
			'section_carousel',
			[
				'label' => esc_html__( 'Carousel Options', 'restaurant-cafe-addon-for-elementor' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'flip' => esc_html__( 'Flip', 'restaurant-cafe-addon-for-elementor' ),
				],
				'default' => 'fade',
		...
		// Slider
			$this->start_controls_section(
				'sectn_style',
				[
					'label' => esc_html__( 'Slider', 'restaurant-cafe-addon-for-elementor' ),
			...
			$this->add_responsive_control(
				'slider_height',
				[
					'label' => esc_html__( 'Slider Height', 'restaurant-cafe-addon-for-elementor' ),
					...
					'size_units' => [ 'px', '%' ],
					'selectors' => [
						'{{WRAPPER}} .narep-swiper-slide.swiper-container' => 'height:{{SIZE}}{{UNIT}};min-height:{{SIZE}}{{UNIT}};',
					],
				]
			);
			$this->add_responsive_control(
				'content_width',
				[
					'label' => esc_html__( 'Content Width', 'restaurant-cafe-addon-for-elementor' ),
					'type' => Controls_Manager::SLIDER,
					'range' => [
						'px' => [
							'min' => 0,
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .narep-overlay:before' => 'background-color: {{VALUE}};',
					],
				]
			);
			$this->add_responsive_control(
			...
			$this->add_responsive_control(
				'slider_padding',
				[
					'label' => __( 'Content Outer Space', 'restaurant-cafe-addon-for-elementor' ),
					'type' => Controls_Manager::DIMENSIONS,
					'size_units' => [ 'px', '%', 'em' ],
					'selectors' => [
			...
			$this->add_control(
				'secn_bg_color',
				[
					'label' => esc_html__( 'Content Background Color', 'restaurant-cafe-addon-for-elementor' ),
					'type' => Controls_Manager::COLOR,
					'selectors' => [
		...
		// Navigation
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px' ],
					'selectors' => [
						'{{WRAPPER}} .narep-swiper-slide.swiper-container .swiper-button-next, {{WRAPPER}} .narep-swiper-slide.swiper-container .swiper-button-prev' => 'width: {{SIZE}}{{UNIT}};height: {{SIZE}}{{UNIT}};',
					],
				]
			);
			$this->start_controls_tabs( 'nav_arrow_style' );
				...
				$this->add_control(
					'nav_arrow_color',
					[
						'label' => esc_html__( 'Arrow Color', 'restaurant-cafe-addon-for-elementor' ),
						'type' => Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .narep-swiper-slide.swiper-container .swiper-button-next:before, {{WRAPPER}} .narep-swiper-slide.swiper-container .swiper-button-prev:before' => 'color: {{VALUE}};',
						],
					]
				);
				$this->add_control(
					...
					[
						...
						'type' => Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .narep-swiper-slide.swiper-container .swiper-button-next, {{WRAPPER}} .narep-swiper-slide.swiper-container .swiper-button-prev' => 'background-color: {{VALUE}};',
						],
					]
				);
				$this->add_group_control(
					...
					[
						'name' => 'nav_border',
						'label' => esc_html__( 'Border', 'restaurant-cafe-addon-for-elementor' ),
						'selector' => '{{WRAPPER}} .narep-swiper-slide.swiper-container .swiper-button-next, {{WRAPPER}} .narep-swiper-slide.swiper-container .swiper-button-prev',
					]
				);
				...
				$this->add_control(
					...
					[
						...
						'type' => Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .narep-swiper-slide.swiper-container .swiper-button-next:hover:before, {{WRAPPER}} .narep-swiper-slide.swiper-container .swiper-button-prev:hover:before' => 'color: {{VALUE}};',
						],
					]
				);
				$this->add_control(
					...
					[
						...
						'type' => Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .narep-swiper-slide.swiper-container .swiper-button-next:hover, {{WRAPPER}} .narep-swiper-slide.swiper-container .swiper-button-prev:hover' => 'background-color: {{VALUE}};',
						],
					]
				);
				$this->add_group_control(
					...
					[
						...
						'label' => esc_html__( 'Border', 'restaurant-cafe-addon-for-elementor' ),
						'selector' => '{{WRAPPER}} .narep-swiper-slide.swiper-container .swiper-button-next:hover, {{WRAPPER}} .narep-swiper-slide.swiper-container .swiper-button-prev:hover',
					]
				);
		...
		// Title
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Highlight Title Color', 'restaurant-cafe-addon-for-elementor' ),
					'type' => Controls_Manager::COLOR,
					'scheme' => [
						'type' => Scheme_Color::get_type(),
						'value' => Scheme_Color::COLOR_1,
		...
		// Sub Title
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px' ],
					'selectors' => [
						'{{WRAPPER}} .banner-sub-title .narep-image' => 'max-width: {{SIZE}}{{UNIT}};',
					],
				]
			);
			$this->end_controls_section();// end: Section
		...
		// Content Image
			...
			$this->add_responsive_control(
				...
				[
					'label' => __( 'Content Margin', 'restaurant-cafe-addon-for-elementor' ),
					'type' => Controls_Manager::DIMENSIONS,
					'size_units' => [ 'px', '%', 'em' ],
					'selectors' => [
	  ...
	  // Button One Style
			...
			$this->add_group_control(
				...
				[
					...
					'selector' => '{{WRAPPER}} .banner-caption .btn-one.narep-btn',
				]
			);
			$this->add_responsive_control(
				'button_one_margin',
				[
					...
					'size_units' => [ 'px', 'em' ],
					'selectors' => [
						'{{WRAPPER}} .btn-one.narep-btn' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px' ],
					'selectors' => [
						'{{WRAPPER}} .banner-caption .btn-one.narep-btn' => 'min-width: {{SIZE}}{{UNIT}};',
					],
				]
			);
			$this->add_control(
				...
				[
					...
					'size_units' => [ 'px', 'em' ],
					'selectors' => [
						'{{WRAPPER}} .banner-caption .btn-one.narep-btn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			$this->add_control(
				...
				[
					...
					'size_units' => [ 'px', '%', 'em' ],
					'selectors' => [
						'{{WRAPPER}} .banner-caption .btn-one.narep-btn' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			$this->start_controls_tabs( 'button_style' );
				...
				$this->add_control(
					...
					[
						...
						'type' => Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .banner-caption .btn-one.narep-btn' => 'color: {{VALUE}};',
						],
					]
				);
				$this->add_control(
					...
					[
						...
						'type' => Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .banner-caption .btn-one.narep-btn' => 'background-color: {{VALUE}};',
						],
					]
				);
				$this->add_group_control(
				...
				$this->add_group_control(
					...
					[
						...
						'selector' => '{{WRAPPER}} .banner-caption .btn-one.narep-btn:after',
					]
				);
				$this->end_controls_tab();  // end:Normal tab
				...
				$this->add_control(
					...
					[
						...
						'type' => Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .banner-caption .btn-one.narep-btn:hover' => 'color: {{VALUE}};',
						],
					]
				);
				$this->add_control(
					...
					[
						...
						'type' => Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .banner-caption .btn-one.narep-btn:hover' => 'background-color: {{VALUE}};',
						],
					]
				);
				$this->add_group_control(
					...
					[
						...
						'label' => esc_html__( 'Border', 'restaurant-cafe-addon-for-elementor' ),
						'selector' => '{{WRAPPER}} .banner-caption .btn-one.narep-btn:hover',
					]
				);
				$this->add_group_control(
					Group_Control_Box_Shadow::get_type(),
					[
						...
						'label' => esc_html__( 'Button Shadow', 'restaurant-cafe-addon-for-elementor' ),
						'selector' => '{{WRAPPER}} .banner-caption .btn-one.narep-btn:hover:after',
					]
				);
				$this->end_controls_tab();  // end:Hover tab
			$this->end_controls_tabs(); // end tabs
		...
		// Button Two
			...
			$this->add_group_control(
				...
				[
					...
					'scheme' => Scheme_Typography::TYPOGRAPHY_4,
					'selector' => '{{WRAPPER}} .banner-caption .btn-two.narep-btn',
				]
			);
			$this->add_responsive_control(
				'button_two_margin',
				[
					...
					'size_units' => [ 'px', 'em' ],
					'selectors' => [
						'{{WRAPPER}} .btn-two.narep-btn' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px' ],
					'selectors' => [
						'{{WRAPPER}} .banner-caption .btn-two.narep-btn' => 'min-width: {{SIZE}}{{UNIT}};',
					],
				]
			);
			$this->add_control(
				...
				[
					...
					'size_units' => [ 'px', 'em' ],
					'selectors' => [
						'{{WRAPPER}} .banner-caption .btn-two.narep-btn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			$this->add_control(
				...
				[
					...
					'size_units' => [ 'px', '%', 'em' ],
					'selectors' => [
						'{{WRAPPER}} .banner-caption .btn-two.narep-btn' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			$this->start_controls_tabs( 'button_two_style' );
				...
				$this->add_control(
					...
					[
						...
						'type' => Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .banner-caption .btn-two.narep-btn' => 'color: {{VALUE}};',
						],
					]
				);
				$this->add_control(
					...
					[
						...
						'type' => Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .banner-caption .btn-two.narep-btn' => 'background-color: {{VALUE}};',
						],
					]
				);
				$this->add_group_control(
				...
				$this->add_group_control(
					...
					[
						'name' => 'btnt_shadow',
						'label' => esc_html__( 'Button Shadow', 'restaurant-cafe-addon-for-elementor' ),
						'selector' => '{{WRAPPER}} .banner-caption .btn-two.narep-btn:after',
					]
				);
				$this->end_controls_tab();  // end:Normal tab
				...
				$this->add_control(
					...
					[
						...
						'type' => Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .banner-caption .btn-two.narep-btn:hover' => 'color: {{VALUE}};',
						],
					]
				);
				$this->add_control(
					...
					[
						...
						'type' => Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .banner-caption .btn-two.narep-btn:hover' => 'background-color: {{VALUE}};',
						],
					]
				);
				$this->add_group_control(
					...
					[
						...
						'label' => esc_html__( 'Border', 'restaurant-cafe-addon-for-elementor' ),
						'selector' => '{{WRAPPER}} .banner-caption .btn-two.narep-btn:hover',
					]
				);
				$this->add_group_control(
					Group_Control_Box_Shadow::get_type(),
					[
						...
						'label' => esc_html__( 'Button Shadow', 'restaurant-cafe-addon-for-elementor' ),
						'selector' => '{{WRAPPER}} .banner-caption .btn-two.narep-btn:hover:after',
					]
				);
				$this->end_controls_tab();  // end:Hover tab
			$this->end_controls_tabs(); // end tabs
		...
		// Link
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', 'em' ],
					'selectors' => [
						'{{WRAPPER}} .narep-link' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', 'em' ],
					'selectors' => [
						'{{WRAPPER}} .narep-link' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			$this->add_group_control(
		...
		// Submit Button
			$this->start_controls_section(
				'submit_button_style',
				[
					'label' => esc_html__( 'Form Submit Button', 'restaurant-cafe-addon-for-elementor' ),
					'tab' => Controls_Manager::TAB_STYLE,
				]
			);
			$this->add_group_control(
	...
	*/
	protected function render() {
		...
		ob_start();
		 ...
		 ?>
<div class="swiper-container narep-swiper-slide swiper-slides swiper-keyboard<?php echo $dot_class; ?>" <?php echo $carousel_loop . $carousel_autoplay . $carousel_effect . $carousel_speed . $clickable_pagi . $carousel_mousedrag; ?> data-swiper="container">
    ...
    <?php
			if ( is_array( $swipeSliders_groups ) && !empty( $swipeSliders_groups ) ){
				foreach ( $swipeSliders_groups as $each_item ) {
					...
					$title_seperator = $sub_title_seperator ? '<span class="narep-image one"><img src="'.esc_url($sub_title_seperator).'" alt="Seperator"></span>' : '';
					$title_seperator_two = $sub_title_seperator ? '<span class="narep-image"><img src="'.esc_url($sub_title_seperator).'" alt="Seperator"></span>' : '';
					...
					if($btn_type === 'link') {
						$btn_class = ' narep-link';
					} else {
						$btn_class = ' narep-btn';
					}

					if($btn_type_two === 'link') {
						$btn_two_class = ' narep-link';
					} else {
						$btn_two_class = ' narep-btn black-btn';
					}
					...
					$button_actual = ($button_one || $button_two) ? '<div class="narep-btn-wrap animated" data-animation="'.esc_attr($button_entrance_animation).'">'.$button_one.$button_two.'</div>' : '';

					$image = $content_image_url ? '<div class="narep-image animated" data-animation="'.esc_attr($image_entrance_animation).'"><img src="'.esc_url($content_image_url).'" alt="Slider"></div>' : '';
					$slider_form = $slider_form ? '<div class="slider-form narep-form animated" data-animation="'.esc_attr($image_entrance_animation).'">'.do_shortcode( $slider_form ).'</div>' : '';
					...
					?>
					<div class="swiper-slide narep-banner narep-overlay" style="background-image: url(<?php echo esc_url($image_url); ?>);"<?php echo esc_attr( $carousel_autoplay_timeout ); ?>>
...
Plugin::instance()->widgets_manager->register_widget_type( new Restaurant_Elementor_Addon_Slider() );
