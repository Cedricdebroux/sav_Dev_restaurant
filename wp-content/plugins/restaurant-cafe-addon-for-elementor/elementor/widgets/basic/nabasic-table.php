<?php
/*
 * Elementor Restaurant & Cafe Addon for Elementor Table Widget
 * Author & Copyright: NicheAddon
*/

namespace Elementor;

if (!isset(get_option( 'rcafe_bw_settings' )['nbeds_table'])) { // enable & disable

if ( ! defined( 'ABSPATH' ) ) exit; // Exit if accessed directly

class Restaurant_Elementor_Addon_Table extends Widget_Base{

	/**
	 * Retrieve the widget name.
	*/
	public function get_name(){
		return 'narestaurant_basic_table';
	}
	...
	*/
	public function get_title(){
		return esc_html__( 'Table', 'restaurant-cafe-addon-for-elementor' );
	}
	...
	*/
	...
	/**
	 * Register Restaurant & Cafe Addon for Elementor Table widget controls.
	...
	*/
	protected function _register_controls(){
		...
		$this->start_controls_section(
			'section_table',
			[
				'label' => esc_html__( 'Table Head', 'restaurant-cafe-addon-for-elementor' ),
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'default' => 'center',
				'selectors' => [
					'{{WRAPPER}} .narep-table td, {{WRAPPER}} .narep-table thead th' => 'text-align: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'table_title' => esc_html__( 'Members', 'restaurant-cafe-addon-for-elementor' ),
					],
		...
		$this->start_controls_section(
			'section_table_bdy',
			[
				'label' => esc_html__( 'Table Body', 'restaurant-cafe-addon-for-elementor' ),
			]
		);
		...
		$repeaterOne->start_controls_tabs( 'table_rows' );
			$repeaterOne->start_controls_tab(
				'table_row1',
				[
					'label' => esc_html__( 'Row', 'restaurant-cafe-addon-for-elementor' ),
				]
			);
		...
		$this->add_control(
			'tableItems_row',
			[
				'label' => esc_html__( 'Table Row', 'restaurant-cafe-addon-for-elementor' ),
				'type' => Controls_Manager::REPEATER,
				'default' => [
					[
						'row_text1' => esc_html__( 'Item #1', 'restaurant-cafe-addon-for-elementor' ),
					],
		...
		$this->start_controls_section(
			'table_style',
			[
				'label' => esc_html__( 'Table', 'restaurant-cafe-addon-for-elementor' ),
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} table.narep-table' => 'background-color: {{VALUE}};',
				],
			]
		);
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .narep-table td',
			]
		);
		$this->add_control(
			'odd_options',
			[
				'label' => __( 'Odd Row', 'restaurant-cafe-addon-for-elementor' ),
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} table.narep-table tbody>tr:nth-child(odd)>td' => 'background-color: {{VALUE}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} table.narep-table tbody>tr:nth-child(odd)>td' => 'color: {{VALUE}};',
				],
			]
		);
		$this->add_control(
			'even_options',
			[
				'label' => __( 'Even Row', 'restaurant-cafe-addon-for-elementor' ),
				'type' => Controls_Manager::HEADING,
				'frontend_available' => true,
				'separator' => 'before',
			]
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} table.narep-table tbody>tr:nth-child(even)>td' => 'background-color: {{VALUE}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} table.narep-table tbody>tr:nth-child(even)>td' => 'color: {{VALUE}};',
				],
			]
		);
		$this->end_controls_section();// end: Section
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .narep-table thead tr' => 'background-color: {{VALUE}};',
				],
			]
		);
		$this->add_group_control(
			...
			[
				'name' => 'secn_border',
				'label' => esc_html__( 'Border', 'restaurant-cafe-addon-for-elementor' ),
				'selector' => '{{WRAPPER}} .narep-table thead tr, {{WRAPPER}} table.narep-table thead:first-child tr:first-child th',
			]
		);
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .narep-table thead tr',
			]
		);
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .narep-table thead th',
			]
		);
		$this->add_control(
			'sastable_head_color',
			[
				...
				'selectors' => [
					'{{WRAPPER}} .narep-table thead th' => 'color: {{VALUE}};',
				],
			]
		);
		$this->end_controls_section();// end: Section
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .narep-table td' => 'color: {{VALUE}};',
					],
				]
			);
			$this->add_control(
				'link_options',
				[
					'label' => __( 'Link', 'restaurant-cafe-addon-for-elementor' ),
					'type' => Controls_Manager::HEADING,
					'frontend_available' => true,
					'separator' => 'before',
				]
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .narep-table td a' => 'color: {{VALUE}};',
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .narep-table td a:hover' => 'color: {{VALUE}};',
					],
				]
			);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px' ],
				'selectors' => [
					'{{WRAPPER}} .narep-table td i' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .narep-table td i' => 'color: {{VALUE}};',
				],
			]
		);
		$this->end_controls_section();// end: Section
	...
	*/
	protected function render() {
	  ...
	  $output = '<div class="narep-responsive-table">
						    <table class="narep-table">
						      <thead>
						        <tr>';
						        // Group Param Output
						      ...
						      <tbody>';
						      	// Group Param Output
										if ( is_array( $tableItems_row ) && !empty( $tableItems_row ) ){
  										...
  										$button1 = !empty( $text_link1 ) ? '<a href="'.esc_url($text_link1).'" '.$text_link1_attr.' class="narep-btn">'.esc_html($row_text1).'</a>' : '';
  										...
  										$button2 = !empty( $text_link2 ) ? '<a href="'.esc_url($text_link2).'" '.$text_link2_attr.' class="narep-btn">'.esc_html($row_text2).'</a>' : '';
  										...
  										$button3 = !empty( $text_link3 ) ? '<a href="'.esc_url($text_link3).'" '.$text_link3_attr.' class="narep-btn">'.esc_html($row_text3).'</a>' : '';
  										...
  										$button4 = !empty( $text_link4 ) ? '<a href="'.esc_url($text_link4).'" '.$text_link4_attr.' class="narep-btn">'.esc_html($row_text4).'</a>' : '';
  										...
  										$button5 = !empty( $text_link5 ) ? '<a href="'.esc_url($text_link5).'" '.$text_link5_attr.' class="narep-btn">'.esc_html($row_text5).'</a>' : '';
...
Plugin::instance()->widgets_manager->register_widget_type( new Restaurant_Elementor_Addon_Table() );
