<?php
/*
 * Elementor Restaurant & Cafe Addon for Elementor About Me Widget
 * Author & Copyright: NicheAddon
*/

namespace Elementor;

if (!isset(get_option( 'rcafe_bw_settings' )['nbeds_about_me'])) { // enable & disable

if ( ! defined( 'ABSPATH' ) ) exit; // Exit if accessed directly

class Restaurant_Elementor_Addon_AboutMe extends Widget_Base{

	/**
	 * Retrieve the widget name.
	*/
	public function get_name(){
		return 'narestaurant_basic_about_me';
	}
	...
	*/
	public function get_title(){
		return esc_html__( 'About Me', 'restaurant-cafe-addon-for-elementor' );
	}
	...
	*/
	...
	/**
	 * Register Restaurant & Cafe Addon for Elementor About Me widget controls.
	...
	*/
	protected function _register_controls(){
		...
		$this->start_controls_section(
			'section_aboutme',
			[
				'label' => __( 'About Me Options', 'restaurant-cafe-addon-for-elementor' ),
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'default' => 'center',
				'selectors' => [
					'{{WRAPPER}} .narep-aboutme-item' => 'align-items: {{VALUE}};',
				],
			]
		);
		$this->add_control(
		...
		$this->add_responsive_control(
			...
			[
				...
				'default' => 'center',
				'selectors' => [
					'{{WRAPPER}} .narep-aboutme-item .narep-image' => 'text-align: {{VALUE}};',
				],
			]
		);
		$this->add_control(
		...
		$this->add_responsive_control(
			...
			[
				...
				'default' => 'center',
				'selectors' => [
					'{{WRAPPER}} .narep-aboutme-item .aboutme-info' => 'text-align: {{VALUE}};',
				],
			]
		);
		...
		// Section
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .narep-aboutme-item' => 'background-color: {{VALUE}};',
					],
				]
			);
			$this->add_group_control(
				...
				[
					...
					'selector' => '{{WRAPPER}} .narep-aboutme-item',
				]
			);
			$this->add_group_control(
		...
		// Image
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px' ],
					'selectors' => [
						'{{WRAPPER}} .narep-aboutme-item .narep-image' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px' ],
					'selectors' => [
						'{{WRAPPER}} .narep-aboutme-item .sign-image' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			$this->add_control(
				...
				[
					...
					'size_units' => [ 'px', '%', 'em' ],
					'selectors' => [
						'{{WRAPPER}} .narep-aboutme-item .narep-image img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			$this->add_group_control(
				...
				[
					'name' => 'image_border',
					'label' => esc_html__( 'Border', 'restaurant-cafe-addon-for-elementor' ),
					'selector' => '{{WRAPPER}} .narep-aboutme-item .narep-image img',
				]
			);
			$this->add_group_control(
				Group_Control_Box_Shadow::get_type(),
	...
	*/
	protected function render() {
		...
		$image = $image_url ? '<div class="narep-image">'.$image_link.'</div>' : '';
		...
		$aboutme_btn = $aboutme_btn_link ? '<div class="narep-btn-wrap"><a href="'.esc_url($aboutme_btn_link).'" class="narep-btn" '.$aboutme_btn_link_attr.'>'.esc_html($aboutme_btn_text).'</a></div>' : '';

		$output = '<div class="narep-aboutme-item zoom-image">
...
Plugin::instance()->widgets_manager->register_widget_type( new Restaurant_Elementor_Addon_AboutMe() );
