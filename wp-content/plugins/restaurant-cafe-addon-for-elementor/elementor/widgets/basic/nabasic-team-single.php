<?php
/*
 * Elementor Restaurant & Cafe Addon for Elementor Team Single Widget
 * Author & Copyright: NicheAddon
*/

namespace Elementor;

if (!isset(get_option( 'rcafe_bw_settings' )['nbeds_team_single'])) { // enable & disable

if ( ! defined( 'ABSPATH' ) ) exit; // Exit if accessed directly

class Restaurant_Elementor_Addon_Team_Single extends Widget_Base{

	/**
	 * Retrieve the widget name.
	*/
	public function get_name(){
		return 'narestaurant_basic_team_single';
	}
	...
	*/
	public function get_title(){
		return esc_html__( 'Team Single', 'restaurant-cafe-addon-for-elementor' );
	}
	...
	*/
	...
	/**
	 * Register Restaurant & Cafe Addon for Elementor Team Single widget controls.
	...
	*/
	protected function _register_controls(){
		...
		$this->start_controls_section(
			'section_team',
			[
				'label' => __( 'Team Single Options', 'restaurant-cafe-addon-for-elementor' ),
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'default' => 'center',
				'selectors' => [
					'{{WRAPPER}} .narep-team-single-item' => 'align-items: {{VALUE}};',
				],
			]
		);
		$this->add_control(
			'image_after',
			[
				'label' => esc_html__( 'Hide Image Shape?', 'restaurant-cafe-addon-for-elementor' ),
		...
		$this->add_control(
			'full_width',
			[
				'label' => esc_html__( 'Full Width?', 'restaurant-cafe-addon-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Yes', 'restaurant-cafe-addon-for-elementor' ),
				'label_off' => esc_html__( 'No', 'restaurant-cafe-addon-for-elementor' ),
				'return_value' => 'true',
		...
		$this->add_responsive_control(
			...
			[
				...
				'default' => 'center',
				'selectors' => [
					'{{WRAPPER}} .narep-team-single-item .narep-image' => 'text-align: {{VALUE}};',
				],
			]
		);
		$this->add_control(
		...
		$this->add_control(
			'infoList_groups',
			[
				'label' => esc_html__( 'Team Mate Informations', 'restaurant-cafe-addon-for-elementor' ),
		...
		$this->add_responsive_control(
			...
			[
				...
				'default' => 'center',
				'selectors' => [
					'{{WRAPPER}} .narep-team-single-item .single-mate-info' => 'text-align: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
					'{{WRAPPER}} .narep-team-single-item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
					'{{WRAPPER}} .narep-team-single-item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .narep-team-single-item' => 'max-width:{{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->start_controls_tabs( 'section_style' );
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .narep-team-single-item' => 'background-color: {{VALUE}};',
					],
				]
			);
			$this->add_group_control(
				...
				[
					...
					'selector' => '{{WRAPPER}} .narep-team-single-item',
				]
			);
			$this->add_group_control(
			...
			$this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .narep-team-single-item:hover' => 'background-color: {{VALUE}};',
					],
				]
			);
			$this->add_group_control(
				...
				[
					...
					'label' => esc_html__( 'Border', 'restaurant-cafe-addon-for-elementor' ),
					'selector' => '{{WRAPPER}} .narep-team-single-item:hover',
				]
			);
			$this->add_group_control(
				Group_Control_Box_Shadow::get_type(),
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px' ],
				'selectors' => [
					'{{WRAPPER}} .narep-team-single-item .narep-image' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->start_controls_tabs( 'secn_style' );
			...
			$this->add_control(
				...
				[
					...
					'size_units' => [ 'px', '%', 'em' ],
					'selectors' => [
						'{{WRAPPER}} .narep-team-single-item .narep-image img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			$this->add_group_control(
				...
				[
					'name' => 'image_border',
					'label' => esc_html__( 'Border', 'restaurant-cafe-addon-for-elementor' ),
					'selector' => '{{WRAPPER}} .narep-team-single-item .narep-image img',
				]
			);
			$this->add_group_control(
				Group_Control_Box_Shadow::get_type(),
			...
			$this->add_control(
				...
				[
					...
					'size_units' => [ 'px', '%', 'em' ],
					'selectors' => [
						'{{WRAPPER}} .narep-team-single-item .narep-image .image-wrap:hover img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			$this->add_group_control(
				...
				[
					...
					'label' => esc_html__( 'Border', 'restaurant-cafe-addon-for-elementor' ),
					'selector' => '{{WRAPPER}} .narep-team-single-item .narep-image .image-wrap:hover img',
				]
			);
			$this->add_group_control(
				Group_Control_Box_Shadow::get_type(),
		...
		$this->start_controls_section(
			'section_image_style',
			[
				'label' => esc_html__( 'Image Border', 'restaurant-cafe-addon-for-elementor' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
					'image_after!' => 'true',
				],
		...
		$this->start_controls_tabs( 'bdr_style' );
			...
			$this->add_responsive_control(
				'border_top',
				[
					'label' => esc_html__( 'Border Top', 'restaurant-cafe-addon-for-elementor' ),
					'type' => Controls_Manager::SLIDER,
					'range' => [
						'px' => [
							'min' => -200,
			...
			$this->add_responsive_control(
				'border_left',
				[
					'label' => esc_html__( 'Border Left', 'restaurant-cafe-addon-for-elementor' ),
					'type' => Controls_Manager::SLIDER,
					'range' => [
						'px' => [
							'min' => -200,
			...
			$this->add_control(
				...
				[
					...
					'size_units' => [ 'px', '%', 'em' ],
					'selectors' => [
						'{{WRAPPER}} .narep-team-single-item .narep-image .image-wrap:after' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			$this->add_group_control(
				...
				[
					'name' => 'img_border',
					'label' => esc_html__( 'Border', 'restaurant-cafe-addon-for-elementor' ),
					'selector' => '{{WRAPPER}} .narep-team-single-item .narep-image .image-wrap:after',
				]
			);
			$this->add_group_control(
				Group_Control_Box_Shadow::get_type(),
			...
			$this->add_control(
				...
				[
					...
					'size_units' => [ 'px', '%', 'em' ],
					'selectors' => [
						'{{WRAPPER}} .narep-team-single-item .narep-image .image-wrap:hover:after' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			$this->add_group_control(
				...
				[
					'name' => 'img_hov_border',
					'label' => esc_html__( 'Border', 'restaurant-cafe-addon-for-elementor' ),
					'selector' => '{{WRAPPER}} .narep-team-single-item .narep-image .image-wrap:hover:after',
				]
			);
			$this->add_group_control(
				Group_Control_Box_Shadow::get_type(),
		...
		$this->add_control(
			'lbt',
			[
				'label' => __( 'List Title', 'restaurant-cafe-addon-for-elementor' ),
		...
		$this->add_control(
			'lbgt',
			[
				'label' => __( 'List Text', 'restaurant-cafe-addon-for-elementor' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'after',
			]
		);
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'label' => esc_html__( 'Text Typography', 'restaurant-cafe-addon-for-elementor' ),
	...
	*/
	protected function render() {
		...
		$image = $image_url ? '<div class="narep-image"><div class="image-wrap'.esc_attr($img_class).'"><img src="'.esc_url($image_url).'" alt="'.esc_attr($team_title).'"></div></div>' : '';
		...
		$output = '<div class="narep-team-single-wrap">
								<div class="narep-team-single-item'.esc_attr($col_class).'">
		...
		$output .= '</ul>'.$content.'<div class="narep-social rounded">';
									// Group Param Output
...
Plugin::instance()->widgets_manager->register_widget_type( new Restaurant_Elementor_Addon_Team_Single() );
