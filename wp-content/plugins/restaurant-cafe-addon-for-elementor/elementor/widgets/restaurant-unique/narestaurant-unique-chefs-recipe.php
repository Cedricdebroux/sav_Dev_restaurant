			            ...
			            <div class="nich-row nich-align-items-center">
			              ...
			              <div class="nich-col-xl-6 nich-col-lg-12'.$f_cls.'">
			                <div class="narep-chefs-info">
			                  ...
			                  <div class="swiper-container narep-swiper-slide swiper-slides swiper-keyboard" '. $carousel_item . $carousel_space . $carousel_loop . $carousel_autoplay . $carousel_effect . $carousel_speed . $clickable_pagi . $carousel_mousedrag.' data-swiper="container"><div class="swiper-wrapper">';
