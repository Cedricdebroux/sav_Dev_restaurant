...
Description: Restaurant & Cafe Addon for Elementor covers all the must-needed elements for creating a perfect Restaurant website using Elementor Page Builder. 35+ Unique & Basic Elementor widget covers all of the Restaurant elements.
Author: NicheAddons
...
if ( !function_exists( 'narestaurant_scripts_styles' ) ) {
    function narestaurant_scripts_styles()
    {
        ...
        wp_enqueue_style(
            'timepicker',
            plugins_url( '/', __FILE__ ) . 'assets/css/bootstrap-timepicker.min.css',
            array(),
            '0.5.2',
            'all'
        );
        ...
        wp_enqueue_script(
            'timepicker',
            plugins_url( '/', __FILE__ ) . 'assets/js/bootstrap-timepicker.min.js',
            array( 'jquery' ),
            '0.5.2',
            true
        );
