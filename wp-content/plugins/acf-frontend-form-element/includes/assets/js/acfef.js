		...
		imagesPreview: function( e, $el ){
			...
			Object.keys(files).forEach(i=>{
				...
				reader.onload = (e) => {
					...
					container.removeClass('acf-hidden image-preview-clone').addClass('acf-gallery-attachment').find('img').attr('src',reader.result);
