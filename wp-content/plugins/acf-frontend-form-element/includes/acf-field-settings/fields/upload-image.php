...
class acf_field_upload_image extends acf_field {
	...
	*/
	...
	function initialize() {
		...
		$this->label = __("Upload Image",'acf');
	...
	*/
	...
	function render_field( $field ) {
		...
		$button_text = isset( $field['button_text'] ) ? $field['button_text'] : __( 'Add Image', 'acf-frontend-form-element' );		
	...
	<div class="hide-if-value">
		<?php if( $uploader == 'basic' ): ?>
			...
			<label class="acf-basic-uploader file-drop">
                <?php acf_file_input(array( 'name' => $field['name'], 'id' => $field['id'], 'class' => 'image-preview', 'accept' => "image/*" ) ); ?>
		...
		<?php else: ?>
			...
			<p><?php _e('No image selected','acf'); ?> <a data-name="add" class="acf-button button" href="#"><?php echo $button_text; ?></a></p>
