...
3. Here we configured the permissions. We left the default administrator role and we added a dynamic option that let's you choose a meta field that gives an id of any given user who should see this. In this case we chose the "Poat Author" which allows the author of the post to see it.
